...
public class users {
    ...
    List<String> friendsEmails;  // New field to store friends' email addresses

    public users() {}

    public users(String userId, String userName, String mail, String password, String profilepic, String status, List<String> friendsEmails) {
        this.userId = userId;
